...
<div class="page-banner">
      <div
        ...
        style="background-image: url(<?php echo get_theme_file_uri('/Users/marcsmith/Local Sites/team-smith-real-estate/app/public/wp-content/themes/TeamSmithRE/images/detroit8.jpg')?>)"
      ></div>
      <div class="page-banner__content container t-center c-white">
        <h1 class="headline headline--large">Welcome!</h1>
        <h2 class="headline headline--medium">
         Welcome to Team Smith Real Estate of Utica Realty!
        </h2>
        <h3 class="headline headline--small">
          
        </h3>
        <a href="contact.html" class="btn btn--large btn--blue"></a>
      </div>
    </div>
